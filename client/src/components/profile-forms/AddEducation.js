...
<h1 className="large text-primary">
      ...
      <p className="lead">
        <i className="fas fa-code-branch"></i> Add any school or bootcamp that you have attented in the past
      </p>
      ...
      <form className="form" onSubmit={e => { e.preventDefault(); addEducation(formData, history); }}>
        ...
        <div className="form-group">
         ...
         <div className="form-group">
          <p><input type="checkbox" name="current"  value={current} onChange={e => {setFormData({...formData, current: !current}); toggleDisabled(!toDateDisabled)}}/>{' '} Current School</p>
        </div>
        <div className="form-group">
          <h4>To Date</h4>
